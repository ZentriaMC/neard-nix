...
rustPlatform.buildRustPackage rec {
  ...
  cargoPatches = [ ./patches/0001-make-near-test-contracts-optional.patch ./patches/Cargo-lock-fix.patch ];
  cargoSha256 = "sha256-dV2QwYTlvx1kRXwjYOGlfZpZihmlXNMZt9ISoms7xPE=";
